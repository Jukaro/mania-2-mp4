...
public class BeatmapDataFromDB {
	...
	public override string ToString() {
		...
		str += $"LastModified: {DateTime.FromBinary(LastModified)}\n";
		...
		str += $"LastPlayed: {DateTime.FromBinary(LastPlayed)}\n";
		str += $"IsOsz2: {IsOsz2}\n";
		str += $"FolderName: {FolderName}\n";
		str += $"LastCheckTime: {DateTime.FromBinary(LastCheckTime)}\n";
