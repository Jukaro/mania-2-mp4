...
namespace Mania2mp4.DataTemplates;

public class ScoreGradeTemplateSelector : IDataTemplate
{
    ...
    public bool Match(object? data)
    {
        ...
        return data is ScoreGrade                        // the provided data needs to be our enum type
